...
@gen_code function Base.zero{ESS,FSS}(::Type{Unum{ESS,FSS}})
  if (FSS < 7)
    ...
    @code :(Unum{ESS,FSS}(z16, z16, z16, zero(ArrayInt{FSS}), z64))
  end
end
...
"""
@gen_code function zero!{ESS,FSS}(x::Type{Unum{ESS,FSS}}, flags::UInt16 = z16)
  @code quote
    x.fsize = z16
    x.esize = z16
    x.flags = flags
...
@gen_code function __infnanset!{ESS,FSS}(x::Type{Unum{ESS,FSS}}, flags::UInt16)
...
function Base.nan{ESS,FSS}(::Type{Unum{ESS,FSS}})
  x = zero(Unum{ESS,FSS})
  __infnanset!(x, UNUM_UBIT_FLAG)
end
doc"""
  the `nan!` function forcibly turns a unum variable into nan.
"""
nan!{ESS,FSS}(x::Unum{ESS,FSS}) = __infnanset!(x, UNUM_UBIT_FLAG)
...
# here.
@gen_code function __mmr_bigexact_set!{ESS,FSS}(x::Type{Unum{ESS,FSS}}, flags::UInt16)
  esize   ::UInt16 = 1 << ESS - 1
...
@gen_code function sss!{ESS,FSS}(x::Type{Unum{ESS,FSS}}, flags::UInt16 = z16)
  esize   ::UInt16 = 1 << ESS - 1
  fsize   ::UInt16 = 1 << FSS - 2
  @code quote
    x.fsize = $esize
...
@gen_code function __set_small_exact!{ESS,FSS}(x::Type{Unum{ESS,FSS}}, flags::UInt16 = z16)
  esize   ::UInt16 = 1 << ESS - 1
  fsize   ::UInt16 = 1 << FSS - 2
  @code quote
    x.fsize = $esize
